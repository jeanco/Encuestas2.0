...
?>	
		...
		<div class="logs">
			...
			<button class="btn btn-default btn-sm"><span class="glyphicon glyphicon-trash"></span> Limpiar logs</button>
		</div>
		<div class="row encuestaForm">
			
			<div class="col-lg-8 col-lg-offset-2 noPad">
				<h1>Encuesta de Origen y Destino - Entrevista Directa</h1>
				...
				<div class="col-lg-12 noPad">
					...
					<div class="col-lg-10 noPad">						
						...
						<div class="col-lg-4 pad2">
							<label>Colonia</label>
							<input class="form-control tabCtrl autocomplete" type="text" name="coloniaOrigen" value="" placeholder="Colonia, Municipio" data-opt="colonias" required>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12 noPad">
					...
					<div class="col-lg-10 noPad">						
						...
						<div class="col-lg-4 pad2">
							<label>Colonia</label>
							<input class="form-control tabCtrl autocomplete" type="text" name="coloniaDestino" value="" placeholder="Colonia, Municipio" data-opt="colonias" required>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12 noPad">
					<div class="col-lg-2 col-lg-offset-6 pad2">
						<button id="odsGuardar" type="button" class="btn tabCtrl">guardar</button>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		tipoVehiculo : [{value: "0",label: "NoCapturado"},{ value: "A", label: "A"},{ value: "P", label: "P"},{ value: "U", label: "U"},{ value: "B", label: "B"},{ value: "C2", label: "C2"},{ value: "C3", label: "C3"},{ value: "C4", label: "C4"},{ value: "C5", label: "C5"},{ value: "C6", label: "C6"},{ value: "C7", label: "C7"},{ value: "C8", label: "C8"},{ value: "C9", label: "C9"}],
		...
		motivo : [{value: "0",label: "NoCapturado"},{value: "T",label: "Trabajo"},{value: "P",label: "Paseo"},{value: "E",label: "Escuela"},{value: "C",label: "Compras"},{value: "V",label: "Varios"}],
		carga : cargas,
