...
//	echo "preferencias";
	...
	$objPHPExcel->getProperties()->setCreator("Servicios Mexicanos de Ingenieria Civil")
			...
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AJ'. (string)($i),'T-1');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AK'. (string)($i),'T-2');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AL'. (string)($i),'T-3');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AM'. (string)($i),'T-4');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AN'. (string)($i),'T-5');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AO'. (string)($i),'T-6');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AP'. (string)($i),'T-7');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AQ'. (string)($i),'T-8');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AR'. (string)($i),'T-9');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AS'. (string)($i),'T-10');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AT'. (string)($i),'VIAJE');
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AU'. (string)($i),'CAPT');
		...
		foreach ($client->excelEstacion($consulta,$skip,$limit) as $fila) 
		 {			
		/*	$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('A'. (string)($i), $prog ); // progresivo
			...
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AJ'. (string)($i), (string)$fila['t1']);//  t1
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AK'. (string)($i), (string)$fila['t2']);//  t2
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AL'. (string)($i), (string)$fila['t3']);//  t3
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AM'. (string)($i), (string)$fila['t4']);//  t4
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AN'. (string)($i), (string)$fila['t5']);//  t5
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AO'. (string)($i), (string)$fila['t6']);//  t6
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AP'. (string)($i), (string)$fila['t7']);//  t7
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AQ'. (string)($i), (string)$fila['t8']);//  t8
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AR'. (string)($i), (string)$fila['t9']);//  t9
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AS'. (string)($i), (string)$fila['t10']);//  t10
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AT'. (string)($i), (string)$fila['tarjetasPd']);//  tarjetadPd
			$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('AU'. (string)($i), (string)$fila['capturista']);//  capturista
...
*/
	...
	header('Content-Disposition: attachment;filename="PD.xlsx"');
